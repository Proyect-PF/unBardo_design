    ...
    products: [
      {
        ...
        description: "Remera liviana y muy suave al tacto. Cuello redondo, con terminación de rib. Bordado en el centro del frente, suave y sin desgaste con el lavado.",
        unit_price: "5000",
        sizes: {
          L: 1
        }
