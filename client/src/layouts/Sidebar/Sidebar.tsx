    ...
    <div className={`flex fixed ${style} w-full bg-black/80 z-40`}>
      <div className="flex flex-col justify-between w-2/3 max-w-lg min-h-screen bg-white">
        <div>
          ...
          {/* 
                    <div onClick={handleClick} id='login' className="flex items-center h-16 pl-5 duration-300 border-l-4 border-white hover:border-l-4 hover:border-gray-700 hover:bg-gray-300 hover:cursor-pointer">
          ...
          {/* <div onClick={handleClick} id='logout' className="flex items-center h-16 pl-5 duration-300 border-l-4 border-white hover:border-l-4 hover:border-gray-700 hover:bg-gray-300 hover:cursor-pointer">
